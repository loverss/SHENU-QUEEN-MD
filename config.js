...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("923164750800,")
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'Sufyan jan 🧚' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'sufyan jan' : process.env.OWNER_NAME,
  ownernumber: process.env.OWNER_NUMBER === undefined ? '923164750800' : process.env.OWNER_NUMBER,
